...
namespace SupersonicWisdomSDK.Editor
{
    internal static class SwMinimumEditorVersionMessageUtils
    {
        ...
        {
            var lastTimeMessageShown = EditorPrefs.GetString(SwEditorConstants.SwKeys.LastTimeMinimumEditorVersionMessageShown, "0");
            ...
            EditorPrefs.SetString(SwEditorConstants.SwKeys.LastTimeMinimumEditorVersionMessageShown, currentTime.ToString());
        }
        ...
        private static void OnEnable()
        {
            ...
            EditorPrefs.DeleteKey(SwEditorConstants.SwKeys.LastTimeMinimumEditorVersionMessageShown);
